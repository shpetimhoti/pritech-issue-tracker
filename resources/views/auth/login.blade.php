...
@section('content')
    <div class="mx-auto max-w-md">
        <div class="mb-8">
            <h1 class="text-3xl font-semibold tracking-tight text-slate-950">Login</h1>
            <p class="mt-2 text-sm text-slate-600">Sign in to create and manage your projects.</p>
        </div>
        ...
        <form action="{{ route('login') }}" method="POST" class="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-center justify-between border-t border-slate-200 pt-6">
                    <a href="{{ route('register') }}" class="text-sm font-medium text-sky-700 hover:text-sky-800">Create account</a>
